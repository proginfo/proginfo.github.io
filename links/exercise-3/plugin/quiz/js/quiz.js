...
function init(callback) {
  ...
  const scriptJQuery = scriptURL + '../../jquery.js';
  const scriptQuiz = scriptURL + '../../slickQuiz.js';

  loadJS(scriptJQuery, function() {
    loadJS(scriptQuiz, function() {
      loadCSS(styleReset, function() {
        loadCSS(styleQuiz, function() {
          loadCSS(styleMaster, function() {
            callback();
          });
        });
      });
  ...
  <div id="` + classname + `">
          ...
          <div class="quizArea">
              <div class="quizHeader">
                  ...
                  <a class="button startQuiz" href="#">Начать!</a>
              </div>
              <!-- where the quiz gets built -->
          </div>
          <div class="quizResults">
              <p class="quizScore">Правильных ответов: <span><!-- where the quiz score goes --></span></p>
